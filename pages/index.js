      ...
      <div className="hero min-h-screen bg-base-200" id="about">
        <div className="flex-col hero-content lg:flex-row-reverse">
          ...
          <div className="prose">
            ...
            <p className="mb-5">
              К 300-летию Екатеринбурга мы решили перевести и исполнить на разных языках песню о
              нашем любимом городе, где живут представители больше 100 национальностей. Уже готовы
              английская, французская и китайская версии. В нашей команде - переводчики,
              исполнители, актёры, танцоры, и просто креативные жители Екатеринбурга. Если есть идеи
              и вы влюблены в этот город, присоединяйтесь к нам!
            </p>
